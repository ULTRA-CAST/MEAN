...
var server = http.createServer(function (request, response){
    ...
    else if(request.url === "/images/elan.jpg") {
        fs.readFile("images/elan.jpg", function(errors, contents) {
    ...
    else if(request.url === "/images/tux.jpg") {
        fs.readFile("images/tux.jpg", function(errors, contents) {
            response.writeHead(200, {"Content-Type": "image/jpg"});
            response.write(contents);
            response.end();
        });  
